...
function lonToX(lonDeg) { return R * (normalizeLon(lonDeg) * PI / 180); }
function xToLon(x) { return normalizeLon((x / R) * 180 / PI); }
 ...
 */
export function getDigiPin(lat, lon, levels = 10) {
...
export function approxCellSizeMeters(levels) {
